...
function Dashboard() {
  ...
  return (
    <div className="mobile-shell pb-28">
      ...
      >
        <h1 className="text-ink text-[24px] font-bold">Your financial picture 📊</h1>
        <p className="text-ink/60 text-[12px]">Last updated: today</p>
      </div>
      ...
      <div className="px-6 space-y-4">
        ...
        >
          <div className="flex items-center justify-between">
            <p className="text-ink/60 text-[11px] uppercase tracking-wider font-semibold">
              Total across all accounts
            </p>
            <span className="text-[11px] bg-white/40 text-ink px-2 py-1 rounded-full font-semibold">
              EUR / UAH
            </span>
          </div>
          <motion.p
            ...
            className="text-ink text-[36px] font-extrabold mt-1"
          >
            €{hasBank ? "4,280" : "1,800"}
          </motion.p>
          <div className="mt-3 flex flex-wrap gap-2">
            {hasBank && (
              <span className="bg-white/40 text-ink text-[12px] rounded-full px-3 py-1.5">
          ...
          <p className="text-ink/60 text-[11px] mt-3">Last synced: just now</p>
        </CCard>

        <CCard delay={0.1}>
          <p className="text-ink/60 text-[11px] uppercase tracking-wider font-semibold mb-3">
            This month
          </p>
          <div className="grid grid-cols-2 gap-3">
            <div>
              <p className="text-ink/60 text-[12px]">💰 Income</p>
              <p className="text-[color:var(--success)] text-[20px] font-bold">€2,200</p>
            </div>
            <div>
              <p className="text-ink/60 text-[12px]">💸 Expenses</p>
        ...
        <CCard delay={0.15}>
          <div className="flex items-center justify-between mb-2">
            <h3 className="text-ink text-[16px] font-bold">Unclaimed benefits 💡</h3>
          ...
          <div className="space-y-2 mt-2">
            {[
              ...
              <div key={b.n} className="flex items-center justify-between bg-white/30 rounded-xl px-3 py-2.5">
                <div>
                  <p className="text-ink text-[13px] font-semibold">{b.n}</p>
                  <p className="text-ink/60 text-[11px]">{b.v}</p>
                </div>
        ...
        <CCard delay={0.2}>
          <h3 className="text-ink text-[16px] font-bold mb-3">Deadlines 🗓</h3>
          <div className="space-y-2">
            {[
              ...
              <div key={d.n} className="flex items-center gap-3">
                ...
                <p className="text-ink text-[13px] flex-1">{d.n}</p>
                <p className="text-ink/60 text-[11px]">{d.d}</p>
              </div>
            ))}
          </div>
        </CCard>
        ...
        <CCard delay={0.25} className="border-l-4 border-coral">
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1">
              <p className="text-ink/60 text-[10px] uppercase tracking-wider font-semibold">
                ✨ Cleo suggests
              </p>
              <p className="text-ink text-[14px] mt-1 leading-snug">
